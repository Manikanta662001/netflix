...
const LandingCards = () => {
  return (
    <div className="flex flex-wrap gap-4 justify-center mb-[2rem] cards-container xs:min-h-[800px] sm:min-h-[500px] md:min-h-[320px]">
      <div className="md:basis-[19.5%] sm:basis-[40%] xs:basis-[100%] bg-custom-gradient rounded-2xl px-[10px] py-[15px] relative">
        <h5 className="text-white text-xl font-medium pb-[2rem]">
          Enjoy on your TV
        </h5>
